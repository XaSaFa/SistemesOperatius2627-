[⬅ Anterior: Sistema informàtic](01-sistema-informatic-hardware-software-firmware.md) · [Índex del bloc](00-index.md) · [🏠 Índex general](../README.md) · [Següent: Concepte del SO ➡](03-concepte-funcions-i-estructura-del-so.md)
